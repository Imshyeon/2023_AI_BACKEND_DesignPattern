...
class OrderStatus(Enum):
    ...
    FAIL_CAUSE_SEASON = (3, '시즌 상품은 비시즌에 주문이 불가합니다.')
    COMPLITE = (4, '주문 완료')
    ...
    def is_fail(self):
        return self in [OrderStatus.FAIL_CAUSE_SOLDOUT, 
                        OrderStatus.FAIL_CAUSE_STOCK,
                        OrderStatus.FAIL_CAUSE_SEASON]   # 이 상태(fail)이면 True
    ...
    def check_order_status(order):
        ...
        elif isinstance(coffee, SeasonCoffee):  # 시즌커피의 인스턴스라면
